...
function decrypt(){
	...
	$decrypted = "";
	$a = openssl_private_decrypt(base64_decode($strEncrypted), $decrypted, $pkeyid);
	$signature = $decrypted;
}
...
fieldset.settings dt span {
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>EQdkp Plus Decryptor</title>
</head>
		...
		<div id="installer">
			<div id="main">
				<div id="content">
					...
					<h1 class="hicon home">Decryptor</h1>
					<?php 
						if(!function_exists('openssl_private_decrypt')){
							echo "<span style=\"font-weight:bold;\">WARNING: openssl_private_decrypt() is missing on your system. Please make sure you enabled openSSL-Support for php.<br /></span>";
						}
					?>
