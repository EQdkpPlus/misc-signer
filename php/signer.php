				...
				<div id="header">
					<div id="headerInner">
						<div class="logoContainer">
							<div id="logo"></div>
							<div id="logotext">Hash Signer</div>
						</div>
					</div>
				</div>
				<div id="installer">
...
<form method="post" action="">
					<fieldset class="settings mediumsettings">
						...
						<dl>
							<dt>
								<label>Signature</label><br /><span>Insert this Signature into the field in the Repository</span>
							</dt>
							<dd><textarea style="width: 94%" rows="8" readonly="readonly" name="data" onclick="this.form.data.select()"><?php echo $signature; ?></textarea></dd>
						</dl>
					</fieldset>
				...
				<div id="footer">
					<div>
					<a href="https://eqdkp-plus.eu/about">EQDKP Plus Hash Signer © 2006 - <?php echo date('Y', time()); ?> by EQDKP Plus Development-Team</a>
					</div>
				</div>
			</div>
			</form>
